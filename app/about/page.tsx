...
That error happened because the last code I gave you was not the full page. It stopped halfway at the next <section>, so JSX broke.

Paste this full replacement into app/about/page.tsx:
...
Uploaded image
Uploaded image
you can  make it a little larger so it fits on the page also you cut off come of the stuff in about 

Yep, this version is closer.

The desktop view looks good now, but mobile/tablet is breaking because the forced gridTemplateColumns: '1.3fr .7fr' is not responsive. That is why the right card content gets cut off.

Use this quick fix:

Find this section style:

gridTemplateColumns: '1.3fr .7fr',
Replace it with:

gridTemplateColumns: 'repeat(auto-fit, minmax(360px, 1fr))',
Then make the card slightly larger:
...
height: '250px',
That should keep the clean desktop layout while preventing the mobile/tablet cutoff.
...
Pasted text.txt
Document
we arent doing mobile now please adjust and add the stuff you cut out. print the whoel .tsx page after you are done 

Thought for a few seconds
Yep. Use this full replacement. It keeps desktop layout, makes the founder card a little larger, restores the full name and all five highlight bullets, but keeps the card compact enough for the landing view. 
